...
func TestICAOwner(t *testing.T) {
	...
	for _, tc := range []struct {
	...
	}{
		{
			desc:                         "valid",
			expectedErr:                  nil,
			expectedStringRepresentation: "petri17dtl0mjt3t77kpuhg2edqzjpszulwhgzcdvagh" + types.Delimiter + "id_1",
			malleate: func() (types.ICAOwner, error) {
				contractAddress = "petri17dtl0mjt3t77kpuhg2edqzjpszulwhgzcdvagh"
		...
		},
		{
			...
			expectedErr: nil,
			expectedStringRepresentation: "petri17dtl0mjt3t77kpuhg2edqzjpszulwhgzcdvagh" + types.Delimiter +
