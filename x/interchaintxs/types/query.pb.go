...
type QueryInterchainAccountAddressRequest struct {
	...
	// connection_id is an IBC connection identifier between Petri and remote
	// chain
...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "petri.interchaintxs.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "petri.interchaintxs.QueryParamsResponse")
	proto.RegisterType((*QueryInterchainAccountAddressRequest)(nil), "petri.interchaintxs.QueryInterchainAccountAddressRequest")
	proto.RegisterType((*QueryInterchainAccountAddressResponse)(nil), "petri.interchaintxs.QueryInterchainAccountAddressResponse")
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.interchaintxs.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) InterchainAccountAddress(ctx context.Context, in *QueryInterchainAccountAddressRequest, opts ...grpc.CallOption) (*QueryInterchainAccountAddressResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.interchaintxs.Query/InterchainAccountAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.interchaintxs.Query/Params",
	}
...
func _Query_InterchainAccountAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.interchaintxs.Query/InterchainAccountAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "petri.interchaintxs.Query",
