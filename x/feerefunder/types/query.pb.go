...
func init() {
	proto.RegisterType((*QueryParamsRequest)(nil), "petri.feerefunder.QueryParamsRequest")
	proto.RegisterType((*QueryParamsResponse)(nil), "petri.feerefunder.QueryParamsResponse")
	proto.RegisterType((*FeeInfoRequest)(nil), "petri.feerefunder.FeeInfoRequest")
	proto.RegisterType((*FeeInfoResponse)(nil), "petri.feerefunder.FeeInfoResponse")
}
...
func (c *queryClient) Params(ctx context.Context, in *QueryParamsRequest, opts ...grpc.CallOption) (*QueryParamsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.feerefunder.Query/Params", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) FeeInfo(ctx context.Context, in *FeeInfoRequest, opts ...grpc.CallOption) (*FeeInfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.feerefunder.Query/FeeInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Query_Params_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.feerefunder.Query/Params",
	}
...
func _Query_FeeInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.feerefunder.Query/FeeInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Query_serviceDesc = grpc.ServiceDesc{
	ServiceName: "petri.feerefunder.Query",
