...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	petritypes.RegisterMsgServer(cfg.MsgServer(), am.keeper)
...
func (AppModuleBasic) RegisterCodec(cdc *codec.LegacyAmino) {
	petritypes.RegisterLegacyAminoCodec(cdc)
}
...
func (am AppModuleBasic) RegisterInterfaces(reg cdctypes.InterfaceRegistry) {
	petritypes.RegisterInterfaces(reg)
...
func NewHandler(k wrapkeeper.KeeperTransferWrapper) sdk.Handler {
	return func(ctx sdk.Context, msg sdk.Msg) (*sdk.Result, error) {
		...
		case *types.MsgTransfer:
			petriMsg := petritypes.MsgTransfer{
			...
			res, err := k.Transfer(sdk.WrapSDKContext(ctx), &petriMsg)
