...
func init() {
	proto.RegisterType((*MsgTransfer)(nil), "petri.transfer.MsgTransfer")
	proto.RegisterType((*MsgTransferResponse)(nil), "petri.transfer.MsgTransferResponse")
}
...
func (c *msgClient) Transfer(ctx context.Context, in *MsgTransfer, opts ...grpc.CallOption) (*MsgTransferResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.transfer.Msg/Transfer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Transfer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.transfer.Msg/Transfer",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "petri.transfer.Msg",
