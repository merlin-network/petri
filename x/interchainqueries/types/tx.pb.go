...
type MsgRegisterInterchainQuery struct {
	...
	// is used to specify how often (in petri blocks) the query must be updated
...
type MsgSubmitQueryResult struct {
	...
	// is the IBC client ID for an IBC connection between Petri chain and target
...
func init() {
	proto.RegisterType((*MsgRegisterInterchainQuery)(nil), "petri.interchainqueries.MsgRegisterInterchainQuery")
	proto.RegisterType((*MsgRegisterInterchainQueryResponse)(nil), "petri.interchainqueries.MsgRegisterInterchainQueryResponse")
	proto.RegisterType((*MsgSubmitQueryResult)(nil), "petri.interchainqueries.MsgSubmitQueryResult")
	proto.RegisterType((*QueryResult)(nil), "petri.interchainqueries.QueryResult")
	proto.RegisterType((*StorageValue)(nil), "petri.interchainqueries.StorageValue")
	proto.RegisterType((*Block)(nil), "petri.interchainqueries.Block")
	proto.RegisterType((*TxValue)(nil), "petri.interchainqueries.TxValue")
	proto.RegisterType((*MsgSubmitQueryResultResponse)(nil), "petri.interchainqueries.MsgSubmitQueryResultResponse")
	proto.RegisterType((*MsgRemoveInterchainQueryRequest)(nil), "petri.interchainqueries.MsgRemoveInterchainQueryRequest")
	proto.RegisterType((*MsgRemoveInterchainQueryResponse)(nil), "petri.interchainqueries.MsgRemoveInterchainQueryResponse")
	proto.RegisterType((*MsgUpdateInterchainQueryRequest)(nil), "petri.interchainqueries.MsgUpdateInterchainQueryRequest")
	proto.RegisterType((*MsgUpdateInterchainQueryResponse)(nil), "petri.interchainqueries.MsgUpdateInterchainQueryResponse")
}
...
func (c *msgClient) RegisterInterchainQuery(ctx context.Context, in *MsgRegisterInterchainQuery, opts ...grpc.CallOption) (*MsgRegisterInterchainQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.interchainqueries.Msg/RegisterInterchainQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) SubmitQueryResult(ctx context.Context, in *MsgSubmitQueryResult, opts ...grpc.CallOption) (*MsgSubmitQueryResultResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.interchainqueries.Msg/SubmitQueryResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) RemoveInterchainQuery(ctx context.Context, in *MsgRemoveInterchainQueryRequest, opts ...grpc.CallOption) (*MsgRemoveInterchainQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.interchainqueries.Msg/RemoveInterchainQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateInterchainQuery(ctx context.Context, in *MsgUpdateInterchainQueryRequest, opts ...grpc.CallOption) (*MsgUpdateInterchainQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/petri.interchainqueries.Msg/UpdateInterchainQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_RegisterInterchainQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.interchainqueries.Msg/RegisterInterchainQuery",
	}
...
func _Msg_SubmitQueryResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.interchainqueries.Msg/SubmitQueryResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_RemoveInterchainQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.interchainqueries.Msg/RemoveInterchainQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Msg_UpdateInterchainQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/petri.interchainqueries.Msg/UpdateInterchainQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "petri.interchainqueries.Msg",
