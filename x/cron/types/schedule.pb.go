...
func init() {
	proto.RegisterType((*Schedule)(nil), "petri.cron.Schedule")
	proto.RegisterType((*MsgExecuteContract)(nil), "petri.cron.MsgExecuteContract")
	proto.RegisterType((*ScheduleCount)(nil), "petri.cron.ScheduleCount")
}
