...
func (qp *QueryPlugin) GetTotalBurnedPetrisAmount(ctx sdk.Context, _ *bindings.QueryTotalBurnedPetrisAmountRequest) (*bindings.QueryTotalBurnedPetrisAmountResponse, error) {
	grpcResp := qp.feeBurnerKeeper.GetTotalBurnedPetrisAmount(ctx)
	return &bindings.QueryTotalBurnedPetrisAmountResponse{Coin: grpcResp.Coin}, nil
}
