...
VOTING_REGISTRY_CONTRACT=$CONTRACTS_BINARIES_DIR/petri_voting_registry.wasm
# VAULTS
PETRI_VAULT_CONTRACT=$CONTRACTS_BINARIES_DIR/petri_vault.wasm
# RESERVE
RESERVE_CONTRACT=$CONTRACTS_BINARIES_DIR/petri_reserve.wasm
DISTRIBUTION_CONTRACT=$CONTRACTS_BINARIES_DIR/petri_distribution.wasm
# SUBDAOS
...
PROPOSAL_SINGLE_LABEL="petri.proposals.single"
PRE_PROPOSAL_SINGLE_LABEL="petri.proposals.single.pre_propose"
...
PROPOSAL_MULTIPLE_LABEL="petri.proposals.multiple"
PRE_PROPOSAL_MULTIPLE_LABEL="petri.proposals.multiple.pre_propose"
...
PROPOSAL_OVERRULE_LABEL="petri.proposals.overrule"
PRE_PROPOSE_OVERRULE_LABEL="petri.proposals.overrule.pre_propose"

## Voting registry
VOTING_REGISTRY_LABEL="petri.voting"

## DAO
DAO_NAME="Petri DAO"
DAO_DESCRIPTION="Petri DAO is a DAO DAO-based governance of Petri chain"
DAO_CORE_LABEL="petri.core"
...
GRANTS_SUBDAO_CORE_LABEL="petri.subdaos.grants.core"
GRANTS_SUBDAO_PROPOSAL_LABEL="petri.subdaos.grants.proposals.single"
GRANTS_SUBDAO_PRE_PROPOSE_LABEL="petri.subdaos.grants.proposals.single.pre_propose"
GRANTS_SUBDAO_VOTING_MODULE_LABEL="petri.subdaos.grants.voting"

## Timelock
GRANTS_SUBDAO_TIMELOCK_LABEL="petri.subdaos.grants.proposals.single.pre_propose.timelock"

## Security subdao
SECURITY_SUBDAO_CORE_NAME="Security SubDAO"
SECURITY_SUBDAO_CORE_DESCRIPTION="SubDAO with power to pause specific Petri DAO modules"
SECURITY_SUBDAO_CORE_LABEL="petri.subdaos.security.core"
SECURITY_SUBDAO_PROPOSAL_LABEL="petri.subdaos.security.proposals.single"
SECURITY_SUBDAO_PRE_PROPOSE_LABEL="petri.subdaos.security.proposals.single.pre_propose"
SECURITY_SUBDAO_VOTE_LABEL="petri.subdaos.security.voting"
...
# VAULTS
PETRI_VAULT_CONTRACT_BINARY_ID=$(store_binary         "$PETRI_VAULT_CONTRACT")
# RESERVE
...
# VAULTS
PETRI_VAULT_CONTRACT_ADDRESS=$(genaddr                "$PETRI_VAULT_CONTRACT_BINARY_ID") && (( INSTANCE_ID_COUNTER++ ))
...
PETRI_VAULT_INIT='{
  "owner": "'"$DAO_CONTRACT_ADDRESS"'",
  "name":         "'"$PETRI_VAULT_NAME"'",
  "denom":        "'"$STAKEDENOM"'",
  "description":  "'"$PETRI_VAULT_DESCRIPTION"'"
}'
...
# If you're to do any changes, please do it consistently in both sections
init_contract "$PETRI_VAULT_CONTRACT_BINARY_ID"   "$PETRI_VAULT_INIT"             "$PETRI_VAULT_LABEL"
